spa.model = (function() {
    ...
    makePerson = function(person_map) {
        let person;
        let cid = person_map.cid;
        let css_map = person_map.css_map;
        let id = person_map.id;
        let name = person_map.name;
    ...
    chat = (function() {
        let _publish_listchange;
        let _publish_updatechat;
        let _update_list;
        let _leave_chat;
        let get_chatee;
        let join_chat;
